...
| 29 Agustus 2026 | SIMANSA REST API dan LMS MANSA | Alias middleware Sanctum abilities dan ability didaftarkan pada bootstrap aplikasi SIMANSA. | Endpoint LMS API kini memverifikasi Bearer token serta kemampuan lms:read dengan benar, bukan gagal 500 sebelum autentikasi diproses. | Commit db1081f dideploy; cache produksi dibangun ulang dan endpoint tanpa token terverifikasi memberi JSON 401 normal. |
| 29 Agustus 2026 | SIMANSA REST API dan LMS MANSA | Endpoint siswa LMS diselaraskan dengan roster tahun ajaran aktif melalui relasi kelasTahunAktif. | Data siswa master aktif yang belum masuk rombel tahun aktif tidak ikut ke LMS; definisi total kini sama dengan kartu Siswa Tahun Aktif dashboard. | Commit 7704452 dideploy; dokumentasi OpenAPI lulus 2/2 (13 assertion) dan health check produksi HTTP 200. |
| 29 Agustus 2026 | SIMANSA REST API dan LMS MANSA | Kontrak endpoint LMS diperluas untuk mengirim profil siswa/GTK yang diperlukan direktori: identitas, kontak, asal sekolah, metadata akademik, dan URL foto. | LMS dapat menyimpan atau menampilkan foto profil tanpa mengakses database SIMANSA maupun mentransfer dokumen pribadi. | Commit 90f25e6 dideploy; lint controller dan dokumentasi OpenAPI lulus 2/2 (13 assertion), health check HTTP 200. |
