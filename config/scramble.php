...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Dokumentasi interaktif REST API SIMANSA untuk integrasi LMS MANSA. Endpoint data membutuhkan Bearer token Sanctum dengan kemampuan lms:read.',
    ],

    'ui' => [
        'title' => 'SIMANSA API Reference',
    ],
