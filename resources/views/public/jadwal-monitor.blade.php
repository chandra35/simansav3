...
<head>
    ...
    <style>
        ...
        .piket-section{padding:clamp(12px,1.2vw,20px);border:1px solid var(--line);border-radius:17px;background:#fff;box-shadow:0 8px 22px rgba(15,23,42,.05)}.piket-section-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:12px;font-size:clamp(13px,1.1vw,17px);font-weight:900}.piket-count{min-width:28px;padding:3px 8px;border-radius:99px;background:#dbeafe;color:#1d4ed8;text-align:center;font-size:12px}.piket-classes{display:grid;grid-template-columns:repeat(auto-fill,minmax(210px,1fr));gap:9px}.piket-class{display:grid;width:100%;grid-template-columns:26px minmax(0,1fr) 54px;align-items:center;gap:8px;min-height:82px;overflow:hidden;padding:9px 10px;border:1px solid #e2e8f0;border-radius:12px;background:linear-gradient(120deg,#fff,#eff6ff);color:inherit;font:inherit;text-align:left;cursor:pointer;transition:transform .15s,box-shadow .15s,border-color .15s}.piket-class--enter{opacity:0;animation:piket-card-in .42s cubic-bezier(.2,.8,.2,1) forwards;animation-delay:var(--card-delay,0ms)}@keyframes piket-card-in{from{opacity:0;transform:translateY(10px) scale(.985)}to{opacity:1;transform:translateY(0) scale(1)}}.piket-class:hover{transform:translateY(-2px);border-color:#93c5fd;box-shadow:0 7px 16px rgba(15,23,42,.1)}.piket-class:focus-visible{outline:3px solid rgba(37,99,235,.3);outline-offset:2px}.piket-class>i{align-self:start;margin-top:3px;color:#2563eb}.piket-class__content{min-width:0}.piket-class:nth-child(6n+2){background:linear-gradient(120deg,#fff,#ecfdf5)}.piket-class:nth-child(6n+2)>i,.piket-class:nth-child(6n+2) .piket-kelas{color:#059669}.piket-class:nth-child(6n+3){background:linear-gradient(120deg,#fff,#f5f3ff)}.piket-class:nth-child(6n+3)>i,.piket-class:nth-child(6n+3) .piket-kelas{color:#7c3aed}.piket-class:nth-child(6n+4){background:linear-gradient(120deg,#fff,#fff7ed)}.piket-class:nth-child(6n+4)>i,.piket-class:nth-child(6n+4) .piket-kelas{color:#ea580c}.piket-kelas{font-size:11px;font-weight:900;color:#2563eb}.piket-mapel{display:-webkit-box;overflow:hidden;margin:2px 0;font-size:14px;font-weight:900;line-height:1.18;-webkit-box-orient:vertical;-webkit-line-clamp:2}.piket-guru{overflow:hidden;color:var(--muted);font-size:11px;text-overflow:ellipsis;white-space:nowrap}.piket-guru i{margin-right:3px}.piket-guru-photo{width:54px;height:68px;justify-self:end;overflow:hidden;border:2px solid #fff;border-radius:10px;object-fit:cover;box-shadow:0 4px 10px rgba(15,23,42,.16)}.piket-empty{padding:10px 0;color:var(--muted);font-size:14px}.piket-timeline{display:flex;gap:8px;margin-top:14px;padding:4px 1px 9px;overflow-x:auto;scrollbar-width:thin;scrollbar-color:#93c5fd transparent}.piket-slot{flex:0 0 118px;display:flex;flex-direction:column;gap:3px;min-height:68px;padding:9px 10px;border:1px solid #dbe5f2;border-radius:11px;background:#fff;color:var(--ink);font:inherit;text-align:left;cursor:pointer;transition:transform .15s,box-shadow .15s,border-color .15s}.piket-slot:hover{transform:translateY(-2px);border-color:#93c5fd;box-shadow:0 6px 14px rgba(15,23,42,.09)}.piket-slot:focus-visible{outline:3px solid rgba(37,99,235,.3);outline-offset:2px}.piket-slot strong{font-size:12px}.piket-slot small{color:var(--muted);font-size:10px;line-height:1.15}.piket-slot.break{border-color:#fed7aa;background:#fffaf0}.piket-slot.current{border-color:#2563eb;background:linear-gradient(135deg,#eff6ff,#dbeafe);box-shadow:0 7px 16px rgba(37,99,235,.14)}.piket-slot.selected{border-color:#0f766e;background:linear-gradient(135deg,#ecfdf5,#ccfbf1);box-shadow:0 7px 16px rgba(15,118,110,.14)}.piket-detail-modal{width:min(92vw,520px);padding:0;border:0;border-radius:18px;color:var(--ink);box-shadow:0 24px 65px rgba(15,23,42,.3)}.piket-detail-modal[open]{animation:piket-modal-in .22s cubic-bezier(.2,.85,.25,1)}.piket-detail-modal.is-closing{animation:piket-modal-out .16s ease-in forwards}.piket-detail-modal::backdrop{background:rgba(15,23,42,.55);backdrop-filter:blur(3px)}.piket-detail-modal[open]::backdrop{animation:piket-backdrop-in .22s ease}@keyframes piket-modal-in{from{opacity:0;transform:translateY(12px) scale(.96)}to{opacity:1;transform:translateY(0) scale(1)}}@keyframes piket-modal-out{to{opacity:0;transform:translateY(8px) scale(.98)}}@keyframes piket-backdrop-in{from{opacity:0}to{opacity:1}}.piket-detail-modal__body{display:grid;grid-template-columns:130px minmax(0,1fr);gap:1rem;padding:1.25rem}.piket-detail-modal__photo{width:130px;aspect-ratio:4/5;overflow:hidden;border-radius:14px;background:#dbeafe;box-shadow:0 8px 18px rgba(37,99,235,.17)}.piket-detail-modal__photo img{width:100%;height:100%;object-fit:cover}.piket-detail-modal__eyebrow{margin-bottom:.35rem;color:#2563eb;font-size:.7rem;font-weight:900;letter-spacing:.08em}.piket-detail-modal__body h2{margin:0 0 .8rem;font-size:1.25rem}.piket-detail-modal__item{padding:.55rem 0;border-top:1px solid #e2e8f0;color:#475569;font-size:.85rem}.piket-detail-modal__item strong{display:block;color:#10213d;font-size:.95rem}.piket-detail-modal__footer{display:flex;justify-content:flex-end;padding:.75rem 1.25rem;border-top:1px solid #e2e8f0;background:#f8fafc}.piket-detail-modal__close{border:0;border-radius:8px;background:#2563eb;color:#fff;padding:.5rem .8rem;font:inherit;font-weight:800;cursor:pointer}@media(prefers-reduced-motion:reduce){.piket-class--enter,.piket-detail-modal[open],.piket-detail-modal.is-closing{animation:none}}@media(max-width:440px){.piket-detail-modal__body{grid-template-columns:92px minmax(0,1fr);padding:1rem}.piket-detail-modal__photo{width:92px}.piket-detail-modal__body h2{font-size:1.05rem}}
        .piket-section-tools{display:flex;align-items:center;gap:9px}.piket-search{width:min(260px,36vw);height:34px;padding:0 11px;border:1px solid #cbd5e1;border-radius:9px;background:#f8fafc;color:var(--ink);font:600 12px inherit;outline:0;transition:border-color .15s,box-shadow .15s}.piket-search:focus{border-color:#2563eb;background:#fff;box-shadow:0 0 0 3px rgba(37,99,235,.13)}.piket-search::placeholder{color:#94a3b8}.piket-match{padding:0 .08em;border-radius:3px;background:#fef08a;color:#713f12}.piket-asrama{display:inline-flex;align-items:center;gap:3px;margin-left:4px;padding:2px 5px;border-radius:99px;background:#dcfce7;color:#15803d;font-size:9px;font-weight:900;vertical-align:1px;white-space:nowrap}.piket-footer{display:flex;align-items:center;justify-content:center;gap:9px;margin-top:13px;padding:10px 14px;border:1px solid #dbe5f2;border-radius:12px;background:rgba(255,255,255,.72);color:#64748b;font-size:11px;font-weight:700;letter-spacing:.035em;text-align:center}.piket-footer strong{color:#1e3a8a;font-weight:900}.piket-footer i{color:#0f766e;font-size:10px}.piket-footer__divider{width:4px;height:4px;border-radius:99px;background:#93c5fd}
        @media(max-width:600px){.piket-monitor{padding:10px}.piket-top{align-items:flex-start}.piket-brand img{display:none}.piket-brand small{font-size:8px}.piket-brand strong{font-size:16px}.piket-clock strong{font-size:21px}.piket-fullscreen{display:none}.piket-now{width:42px;padding:0;justify-content:center}.piket-now span{display:none}.piket-classes{grid-template-columns:1fr}.piket-focus{margin:10px 0}.piket-timeline{margin-top:10px}.piket-section-head{align-items:flex-start;flex-direction:column}.piket-section-tools{width:100%;justify-content:space-between}.piket-search{width:calc(100% - 44px)}.piket-footer{flex-wrap:wrap;gap:6px;font-size:10px}.piket-footer__divider{display:none}}
    </style>
</head>
<body>
<main class="piket-monitor">
    ...
    <section class="piket-section"><div class="piket-section-head"><span id="monitorSectionTitle"><i class="fas fa-chalkboard-teacher text-primary"></i> Kegiatan kelas saat ini</span><div class="piket-section-tools"><input class="piket-search" id="monitorSearch" type="search" placeholder="Cari kelas, mapel, atau guru" aria-label="Cari kegiatan kelas"><span class="piket-count" id="monitorCount">0</span></div></div><div class="piket-classes" id="monitorClasses"></div></section>
    <section class="piket-timeline" id="monitorTimeline" aria-label="Urutan jam pelajaran hari ini"></section>
    <footer class="piket-footer"><strong>SIMANSA</strong><span class="piket-footer__divider"></span><span>Monitor Pembelajaran Langsung</span><span class="piket-footer__divider"></span><span><i class="fas fa-sync-alt"></i> Diperbarui otomatis</span></footer>
</main>
<dialog class="piket-detail-modal" id="scheduleDetailModal" aria-labelledby="scheduleDetailTitle"><div class="piket-detail-modal__body"><div class="piket-detail-modal__photo"><img id="scheduleDetailPhoto" alt="Foto GTK"></div><div><div class="piket-detail-modal__eyebrow"><i class="fas fa-chalkboard-teacher"></i> DETAIL PEMBELAJARAN</div><h2 id="scheduleDetailTitle">-</h2><div class="piket-detail-modal__item">Kelas<strong id="scheduleDetailClass">-</strong></div><div class="piket-detail-modal__item">Jenis kelas<strong id="scheduleDetailDormitory">-</strong></div><div class="piket-detail-modal__item">Mata pelajaran<strong id="scheduleDetailSubject">-</strong></div><div class="piket-detail-modal__item">Guru pengajar<strong id="scheduleDetailTeacher">-</strong></div></div></div><div class="piket-detail-modal__footer"><button type="button" class="piket-detail-modal__close" id="scheduleDetailClose"><i class="fas fa-times mr-1"></i>Tutup</button></div></dialog>
<script>
(() => {
    ...
    const highlight = value => {
        ...
        return query ? text.replace(new RegExp(`(${escapePattern(escape(query))})`, 'ig'), '<mark class="piket-match">$1</mark>') : text;
    };
    ...
    const setScheduleCards = (key, markup) => {
        if (key === lastClassesKey) return;
        lastClassesKey = key;
        classes.innerHTML = markup;
    };

    const decorateCards = data => {
        classes.querySelectorAll('[data-schedule-detail]').forEach((card, index) => {
            const item = data[index];
            if (!item) return;
            const kelas = card.querySelector('.piket-kelas');
            const mapel = card.querySelector('.piket-mapel');
            const guru = card.querySelector('.piket-guru');
            kelas.innerHTML = `${highlight(item.kelas)}${item.is_asrama ? '<span class="piket-asrama"><i class="fas fa-mosque"></i>Asrama</span>' : ''}`;
            mapel.innerHTML = highlight(item.mapel);
            guru.innerHTML = `<i class="fas fa-user-tie"></i>${highlight(item.guru)}`;
            card.dataset.asrama = item.is_asrama ? 'Asrama' : 'Reguler';
        });
    };
    ...
    function render() {
        ...
        if (displayed) {
            ...
            const allData = breakTime ? [] : displayed.kelas;
            const query = searchInput.value.trim().toLocaleLowerCase('id');
            const data = query ? allData.filter(item => `${item.kelas} ${item.mapel} ${item.guru} ${item.is_asrama ? 'asrama' : 'non asrama'}`.toLocaleLowerCase('id').includes(query)) : allData;
            document.getElementById('monitorCount').textContent = breakTime ? '—' : data.length;
            const classKey = `${displayed.tipe}:${displayed.jam_ke}:${query}:${data.map(item => `${item.kelas}|${item.mapel}|${item.guru}|${item.is_asrama}|${item.foto_guru || ''}`).join('~')}`;
            setScheduleCards(classKey, data.length ? data.map((item, index) => `<button type="button" class="piket-class piket-class--enter" style="--card-delay:${Math.min(index, 11) * 42}ms" data-schedule-detail data-kelas="${escape(item.kelas)}" data-mapel="${escape(item.mapel)}" data-guru="${escape(item.guru)}" data-foto="${escape(item.foto_guru || '')}" aria-label="Lihat detail jadwal ${escape(item.kelas)}, ${escape(item.mapel)}, guru ${escape(item.guru)}"><i class="fas ${icon(item.mapel)}"></i><div class="piket-class__content"><div class="piket-kelas">${escape(item.kelas)}</div><div class="piket-mapel">${escape(item.mapel)}</div><div class="piket-guru"><i class="fas fa-user-tie"></i>${escape(item.guru)}</div></div>${item.foto_guru ? `<img class="piket-guru-photo" src="${escape(item.foto_guru)}" alt="" onerror="this.remove()">` : '<span></span>'}</button>`).join('') : `<div class="piket-empty">${breakTime ? `${escape(displayed.label)} merupakan kegiatan khusus tanpa jadwal kelas.` : 'Jadwal masih kosong pada jam ini.'}</div>`);
            if (query) document.getElementById('monitorCount').textContent = `${data.length}/${allData.length}`;
            decorateCards(data);
            if (query && !data.length) classes.querySelector('.piket-empty').textContent = `Tidak ada hasil untuk “${searchInput.value.trim()}”.`;
        } else {
            ...
            setScheduleCards(`idle:${next?.jam_ke ?? 'none'}`, '<div class="piket-empty">Belum ada pembelajaran yang sedang berlangsung.</div>');
        }
    ...
    classes.addEventListener('click', event => {
        ...
        document.getElementById('scheduleDetailDormitory').textContent = card.dataset.asrama;
        ...
        detailModal.classList.remove('is-closing');
        if (detailModal.open) detailModal.close();
        detailModal.showModal();
    });
    const closeDetailModal = () => {
        if (!detailModal.open || detailModal.classList.contains('is-closing')) return;
        detailModal.classList.add('is-closing');
        clearTimeout(modalCloseTimer);
        modalCloseTimer = setTimeout(() => detailModal.close(), 170);
    };
    document.getElementById('scheduleDetailClose').addEventListener('click', closeDetailModal);
    detailModal.addEventListener('cancel', event => { event.preventDefault(); closeDetailModal(); });
    detailModal.addEventListener('click', event => { if (event.target === detailModal) closeDetailModal(); });
    detailModal.addEventListener('close', () => detailModal.classList.remove('is-closing'));
