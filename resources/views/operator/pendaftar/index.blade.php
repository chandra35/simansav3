...
@section('title', 'Kelola Pendaftar PPDB')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-user-graduate mr-2"></i>Kelola Pendaftar PPDB</h1>
    </div>
@stop
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-3">
                <select class="form-control form-control-sm" id="filterJalur">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('operator.pendaftar.export') }}" class="btn btn-success btn-sm">
        ...
        columns: [
            ...
            { data: 'tanggal' },
            {
                ...
                render: function(data) {
                    return '<a href="{{ url("operator/pendaftar") }}/' + data + '" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>';
                }
            }
        ],
        order: [[7, 'desc']],
