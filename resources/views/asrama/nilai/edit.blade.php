...
<form method="post" action="{{ route('asrama.nilai.update',$pengampu) }}" data-asrama-loading data-loading-title="Menyimpan nilai santri" data-loading-text="Nilai sedang divalidasi dan disimpan.">@csrf @method('PUT')
