...
<div class="card bg-gradient-primary text-white mb-3"><div class="card-body py-3"><div class="row align-items-center"><div class="col-lg-8"><h4 class="mb-1"><i class="fas fa-exchange-alt mr-2"></i>Riwayat Keaktifan GTK</h4><p class="mb-0">Catat mutasi masuk/keluar, pensiun, meninggal, mengundurkan diri, dan perubahan status lain tanpa menghapus histori GTK.</p></div><div class="col-lg-4 mt-3 mt-lg-0 text-lg-right">@can('manage-status-gtk')<button class="btn btn-success" data-toggle="modal" data-target="#statusModal"><i class="fas fa-user-edit mr-1"></i> Ubah Status GTK</button>@endcan</div></div></div></div>

<div class="row">
@foreach([['GTK Aktif',$stats['aktif'],'success','user-check'],['GTK Nonaktif',$stats['nonaktif'],'secondary','user-slash'],['Pensiun',$stats['pensiun'],'warning','hourglass-end'],['Mutasi Keluar',$stats['mutasi'],'info','people-arrows']] as [$label,$value,$color,$icon])
