    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-success">
                ...
                <form action="{{ route('admin.cetak.id-card-siswa') }}" method="POST" id="formCetakIdSiswa" target="_blank">
                    @csrf
                    <div class="card-body">
                        <div class="alert alert-success">
                            <i class="fas fa-info-circle"></i>
                            <strong>Cetak Kartu Pelajar</strong><br>
                            Pilih kelas untuk mencetak ID Card siswa. Kartu akan dicetak dalam format standar (85.6mm x 54mm) dengan bagian depan dan belakang.
                        </div>
...
$(document).ready(function() {
    ...
    $('#formCetakIdSiswa').on('submit', function(e) {
        ...
        Swal.fire({ icon: 'info', title: 'Sedang Mencetak...', text: `Mencetak ID Card siswa dari ${count} kelas. Mohon tunggu...`, allowOutsideClick: false, showConfirmButton: false, willOpen: () => { Swal.showLoading(); } });
