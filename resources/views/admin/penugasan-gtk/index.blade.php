...
@media(min-width:992px) and (max-width:1439.98px){.gtk-assignment-page .assignment-hero-copy{flex:0 0 58.333333%;max-width:58.333333%}.gtk-assignment-page .assignment-hero-actions{flex:0 0 41.666667%;max-width:41.666667%}.gtk-assignment-page .assignment-stat .card-body{padding:.75rem}.gtk-assignment-page .stat-icon{width:38px;height:38px;margin-right:.55rem}.gtk-assignment-page .assignment-filter>.row>[class*="col-"]{padding-left:.35rem;padding-right:.35rem}}
