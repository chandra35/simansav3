                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" id="kurikulum_id" class="form-control" value="{{ $mapel->kurikulum?->nama_kurikulum ?? 'Kurikulum tidak tersedia' }}" readonly>
                                <div class="input-group-append"><span class="input-group-text mapel-locked-label"><i class="fas fa-lock"></i> Terkunci</span></div>
                            </div>
                            <small class="text-muted">Kurikulum tidak berubah saat edit mapel atau ID EMIS.</small>
                            @error('kurikulum_id')
