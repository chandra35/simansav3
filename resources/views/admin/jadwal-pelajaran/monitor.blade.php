...
.jadwal-monitor__timeline{display:flex;gap:.55rem;overflow-x:auto;padding:.8rem;margin-top:1rem}.jm-slot{min-width:125px;border:1px solid #e2e8f0;border-radius:11px;padding:.55rem .65rem;color:#64748b;background:#f8fafc}.jm-slot--current{border-color:#2563eb;background:linear-gradient(135deg,#2563eb,#3b82f6);color:#fff;box-shadow:0 6px 14px rgba(37,99,235,.22)}.jm-slot--current strong{color:#fff}.jm-slot--next{border-color:#14b8a6;background:#f0fdfa}.jm-slot strong{display:block;color:#10213d;font-size:.88rem}.jm-slot small{display:block;font-size:.74rem}
