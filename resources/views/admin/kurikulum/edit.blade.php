    ...
    <form action="{{ route('admin.kurikulum.update', $kurikulum->id) }}" method="POST">
        ...
        <div class="simansa-form-hero mb-4">
            <div class="simansa-form-hero__eyebrow">
                <i class="fas fa-pen-nib"></i> Penyesuaian Kurikulum
            </div>
            <h2>Edit Kurikulum</h2>
            <p>Perbarui informasi dasar kurikulum tanpa mengubah alur akademik yang sudah berjalan. Pastikan perubahan nama, kode, dan struktur jurusan tetap konsisten dengan data tahun pelajaran yang memakainya.</p>
        </div>
