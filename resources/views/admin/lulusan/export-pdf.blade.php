...
<body>
    ...
    <div class="note">
        PDF ini disusun sebagai ringkasan statistik agar tetap ringan dan stabil saat dicetak.
        Untuk detail lengkap per siswa, gunakan export Excel dari halaman admin lulusan.
    </div>
</body>
</html>
