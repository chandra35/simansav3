                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('jenis_kelas') is-invalid @enderror"
                                        ...
                                        <option value="reguler" {{ old('jenis_kelas', $kelas->jenis_kelas ?? 'reguler') === 'reguler' ? 'selected' : '' }}>Reguler</option>
                                        <option value="matrikulasi" {{ old('jenis_kelas', $kelas->jenis_kelas ?? 'reguler') === 'matrikulasi' ? 'selected' : '' }}>Matrikulasi PPDB</option>
                                    </select>
                                    @error('jenis_kelas')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
