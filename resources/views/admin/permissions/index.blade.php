...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1><i class="fas fa-key text-primary mr-1"></i> Permission Management</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <h2 class="h4 mb-2">Permission Management</h2>
                    <p class="mb-0">Kelola daftar permission dan kategori hak akses sistem dengan struktur yang konsisten dan mudah diaudit.</p>
                </div>
                <div class="col-lg-4 mt-3 mt-lg-0">
                    <div class="row text-center">
                        <div class="col-6 border-right border-white-50"><div class="text-uppercase small font-weight-bold text-white-50">Permission</div><div class="h3 mb-0">{{ $permissions->count() }}</div></div>
                        <div class="col-6"><div class="text-uppercase small font-weight-bold text-white-50">Kategori</div><div class="h3 mb-0">{{ $groupedPermissions->count() }}</div></div>
                    </div>
                </div>
            </div>
        </div>
