...
@section('content')
    ...
    @else
        <section class="attendance-filter mb-4">
            ...
            <form method="GET" action="{{ route('admin.absensi-siswa.index') }}" id="attendanceFilterForm" class="attendance-filter__form row">
                ...
                @endif
                <div class="col-12 col-md-6 col-lg-2 attendance-filter__action"><button class="btn btn-primary w-100"><i class="fas fa-sync-alt mr-1"></i>Muat Sesi</button></div>
            </form>
        </section>
        ...
        @if($canBulkGenerate)
            <section class="attendance-bulk mb-4">
                ...
                <form method="POST" action="{{ route('admin.absensi-siswa.generate-draft') }}" id="bulkDraftForm" class="attendance-bulk__form row">
                    @csrf
                    ...
                    <div class="form-group col-12 col-md-6 col-lg-4"><label>Cakupan</label><select name="scope" id="bulkDraftScope" class="form-control"><option value="all">Semua kelas aktif</option><option value="selected">Kelas tertentu</option></select></div>
                    ...
                    <div class="col-12 col-lg-5 attendance-bulk__action"><button type="submit" class="btn btn-primary attendance-bulk__submit"><i class="fas fa-file-medical mr-1"></i>Buat Draft</button></div>
                </form>
            </section>
        @endif
