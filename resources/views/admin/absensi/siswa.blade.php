                            ...
                            <table class="table attendance-table">
                                ...
                                @foreach($students as $index => $siswa)
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="notes[{{ $siswa->id }}]" value="{{ old("notes.$siswa->id",$record?->notes) }}" class="form-control form-control-sm" maxlength="500" placeholder="Keterangan opsional"></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
