...
<style>
.attendance-class-link__teacher{display:block;margin-top:.3rem;color:#6b788c;font-size:.7rem}.attendance-class-link__attendance{display:flex;gap:.45rem;margin-top:.55rem}.attendance-class-link__attendance span{padding:.2rem .4rem;border-radius:6px;background:#eef4ff;color:#3d5e9d;font-size:.64rem;font-weight:700}.attendance-class-link__attendance b{margin-left:.15rem;color:#182b50}.attendance-class-link.has-absence{border-color:#f3c46b;background:#fffaf0}.attendance-class-link.has-absence .attendance-class-link__attendance span:last-child{background:#fff0c7;color:#9a6200}.attendance-student-row.is-attendance-exception td{background:#fff8df}.attendance-student-row.is-attendance-exception td:first-child{box-shadow:inset 3px 0 0 #f0ab26}
</style>
@stop
