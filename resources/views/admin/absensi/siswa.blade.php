    ...
    @else
        <section class="attendance-filter mb-4">
            ...
            <form method="GET" action="{{ route('admin.absensi-siswa.index') }}" id="attendanceFilterForm" class="attendance-filter__form row g-3 align-items-end">
                ...
                @endif
                <div class="col-12 col-md-6 col-lg-2 ml-lg-auto attendance-filter__action"><button class="btn btn-primary attendance-form__button"><i class="fas fa-sync-alt mr-1"></i>Muat Sesi</button></div>
            </form>
        </section>
        ...
        @if($canBulkGenerate)
            <section class="attendance-bulk mb-4">
                ...
                <form method="POST" action="{{ route('admin.absensi-siswa.generate-draft') }}" id="bulkDraftForm" class="attendance-bulk__form row g-3 align-items-end">
                    ...
                    <div class="col-12 col-lg-2 ml-lg-auto attendance-bulk__action"><button type="submit" class="btn btn-primary attendance-form__button"><i class="fas fa-file-medical mr-1"></i>Buat Draft</button></div>
                </form>
            </section>
        @endif
