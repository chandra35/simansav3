...
<style>
    ...
    .detail-item--meta { padding: .55rem .7rem; border-style: dashed; background: #f8fafc; }
    .detail-item--meta small { color: #94a3b8; font-size: .62rem; }
    .detail-item--meta strong { color: #64748b; font-size: .78rem; font-weight: 600; }
    .detail-section-label { grid-column: 1 / -1; margin: .35rem 0 -.2rem; color: #64748b; font-size: .7rem; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; }
