...
@section('content_header')
    <h1><i class="fas fa-plus mr-2"></i>Tambah Template Surat</h1>
@stop

@section('content')
    <div class="card">
        <form action="{{ route('admin.surat-keterangan.template.store') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <textarea name="template_content" id="template_content" 
                        ...
                        rows="15" required>{{ old('template_content') }}</textarea>
