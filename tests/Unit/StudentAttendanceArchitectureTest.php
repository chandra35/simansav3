...
class StudentAttendanceArchitectureTest extends TestCase
{
    ...
    public function test_student_analytics_is_in_homeroom_menu_and_uses_notes_with_strict_scope(): void
    {
        ...
        $this->assertStringContainsString('student-profile-card', $historyView);
    ...
    public function test_face_registration_has_voice_guidance_and_avoids_single_frame_duplicate_blocks(): void
    {
        ...
        $this->assertStringContainsString('function buildDescriptorsFromCapturedPhotos()', $view);
        $this->assertStringContainsString('function detectDescriptorWithWatchdog(image, options)', $view);
        $this->assertStringContainsString("capturedAngles.indexOf('frontal')", $view);
