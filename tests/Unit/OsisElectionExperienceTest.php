...
class OsisElectionExperienceTest extends TestCase
{
    ...
    public function test_packages_support_campaign_photo_and_live_gallery(): void
    {
        ...
        $this->assertStringContainsString('data-results-visible', $liveView);
        $this->assertStringContainsString('setResultsVisibility', $liveView);
        ...
        $this->assertStringNotContainsString('creditRoll', $liveView);
        ...
        $this->assertStringContainsString('aspect-ratio:4/5', $liveView);
        $this->assertStringContainsString('height:min(82%,480px)', $liveView);
        $this->assertStringContainsString('width:92%;height:92%;object-fit:contain;object-position:center', $liveView);
