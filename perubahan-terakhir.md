...
- Area **Buat Draft Massal** kini memiliki hierarki visual yang lebih rapi: ikon konteks, penanda khusus admin, form yang terbingkai, ukuran kontrol yang seragam, dan tombol aksi yang sejajar di sisi kanan seperti tombol Muat Sesi tanpa memenuhi seluruh lebar panel. Kedua form kini memakai grid Bootstrap responsif `row g-3 align-items-end`; tombol aksi konsisten 170 px di desktop dan lebar penuh pada ponsel.
