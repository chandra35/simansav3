...
- Feedback sukses memiliki fallback aman dan halaman otomatis dimuat ulang setelah proses selesai.
...
- Daftar **Data Siswa KIP/SKTM/PKH** kini memiliki kolom **Tindak Lanjut** untuk menandai seluruh pendataan atau pengajuan bantuan yang sudah diproses, baik KIP, KKS/PKH, maupun SKTM.
- Penanda ini disimpan terpisah dari status umum siswa masuk EMIS dan dari status dokumen, sehingga menjadi alur kerja khusus daftar bantuan.
- Pengguna yang mempunyai permission KIP dan edit data siswa dapat menandai atau membatalkan status langsung dari setiap baris; waktu dan pelaku perubahan tercatat pada audit activity.
...
- Halaman daftar token kini menangani waktu penggunaan atau kadaluarsa yang masih kosong, sehingga token baru dapat langsung ditampilkan tanpa error.
...
- Placeholder pencarian kini menjelaskan bahwa siswa dapat dicari berdasarkan nama atau NISN. Pada mode harian, daftar kelas juga tersedia sebagai kartu cepat; klik kelas membuka detail presensinya, lalu siswa dapat langsung dicari dan status kehadirannya diubah di dalam daftar yang sama.
...
- Permission khusus `cetak-id-card-siswa` tersedia pada modul **Data Siswa** di Role & Permission serta Akses Khusus User. Permission ini mengendalikan halaman, pencarian AJAX, PDF, dan menu ID Card Siswa; GTK tidak menerimanya secara otomatis dan dapat diberi maupun dicabut per akun sesuai penugasan.
...
- Nama siswa pada daftar KIP/KKS/PKH/SKTM kini dapat diklik untuk membuka modal detail yang sama dengan Data Siswa: Data Siswa, Data Diri, Orang Tua, Sekolah Asal, dan Dokumen. Aksi di kolom terakhir tetap menjadi tautan ke halaman detail penuh.
...
- DataTable Prestasi Siswa kini memakai satu empty-state Bahasa Indonesia di dalam tabel, kontrol jumlah data yang compact, header berdivider halus, dan footer/pagination dengan ruang bawah yang cukup. Grid modal Prestasi juga ditata ulang menjadi lomba–tahun yang proporsional, tiga kolom metadata yang seimbang, Select2 peserta yang tidak melonggar saat kosong, serta teks bantuan berkontras lebih baik.
