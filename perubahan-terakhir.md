...
- Ringkasan Dashboard Siswa kini memiliki card KKS/PKH. Link pada card KKS/PKH dan Dokumen Wajib mengarah ke form upload yang tepat; halaman Dokumen membaca parameter aman `upload` lalu membuka modal KK, Ijazah, KIP, KKS/PKH, atau SKTM secara langsung.
